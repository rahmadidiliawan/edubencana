...
// Waktu yang digunakan pemain (dalam detik)
const waktuTerpakai = 300 - waktu;

// Ubah ke format MM:SS
const menit = Math.floor(waktuTerpakai / 60);
const detik = waktuTerpakai % 60;

const waktuMain =
    String(menit).padStart(2, "0") + ":" +
    String(detik).padStart(2, "0");

// Simpan waktu untuk ditampilkan di hasil.html
localStorage.setItem("waktu", waktuMain);

// Simpan waktu dalam detik untuk leaderboard
localStorage.setItem("waktuDetik", waktuTerpakai);
